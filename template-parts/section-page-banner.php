				...
				?>
					<div class="swiper-slide">
						...
						<div class="grid-container content">
							<div class="grid-x grid-padding-x align-center align-middle flex-dir-column medium-flex-dir-row-reverse">
								<?php if( !empty($text_banner) ):?>
									<div class="cell small-12 medium-6 large-5 position-relative">
										<h2 class="h3 color-white uppercase"><?=esc_html($text_banner);?></h2>
									</div>
								<?php endif;?>
								<?php if( !empty( $video_modal_url ) ):?>
									<div class="btn-wrap cell small-12 medium-6 large-5 large-offset-1 position-relative">
